  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-block bg-purple-100 text-gray-800 text-xs sm:text-sm px-6 py-2 rounded-full mb-6 shadow">
          Case Management made simpler
        </div>

        {/* Main Headline */}
        <div className="flex justify-center flex-wrap items-center">
          <img src="/assets/section1img5.png" alt="icon" className="h-[39px] sm:h-[69px] px-2 sm:px-8 mb-3" />
          {/* <img src="/assets/section1img2.png" alt="icon" className="hidden sm:block h-[39px] sm:h-[69px] px-0 sm:px-" /> */}
        ...
        {/* Description */}
        <p className="max-w-2xl mx-auto text-gray-600 text-[13px] sm:text-lg md:text-[18px] pt-3 sm:pt-10 mb-6 sm:mb-10 leading-relaxed px-3">
        ...
        <div className="flex flex-row justify-center items-center space-y-0 sm:space-x-6">
          <button
            type="button"
            className="bg-[#834CFF] hover:bg-[#6E3EDB] text-white font-medium py-3 px-8 rounded-full text-[12px] sm:text-lg shadow-lg hover:shadow-xl transition duration-200 ease-in-out transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-75 w-[50%] sm:w-auto"
          >
            Get Started Now
          </button>
          <button
            type="button"
            className="bg-transparent hover:bg-purple-100 text-[#834CFF] font-semibold py-3 px-12 rounded-full text-[12px] sm:text-lg border-2 border-[#834CFF]hover:border-purple-700 shadow-lg hover:shadow-xl transition duration-200 ease-in-out transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-75 w-[50%] sm:w-auto"
          >
            Book A Demo
          </button>
        </div>
