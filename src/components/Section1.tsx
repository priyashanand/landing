    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center  flex-wrap items-center">
          <img src="src/assets/section1img1.png" alt="icon" className="h-[39px] sm:h-[69px] px-2 sm:px-0" />
          <img src="src/assets/section1img2.png" alt="icon" className="hidden sm:block h-[39px] sm:h-[69px] px-0 sm:px-9" />
          ...
          <img src="src/assets/section1img3.png" alt="icon" className="h-[39px] sm:h-[69px] px-2 sm:px-9" />
