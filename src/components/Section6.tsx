...
const Section6 = () => {
  return (
    <div
  className="h-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-20 text-white bg-[url(/assets/image.png)] bg-no-repeat bg-cover bg-center py-10 sm:py-20"
>
  {/* Left side text */}
  <div className="mb-10 md:mb-0">
    <h2 className="text-[24px] sm:text-[64px] font-extrabold leading-tight text-center md:text-left px-4 md:pl-16">
  ...
  <div className="text-center md:text-left max-w-[75%] sm:max-w-[37%]">
    <p className="mb-4 text-[12px] md:text-[20px] text-gray-300 md:pr-10">
