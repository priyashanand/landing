const Footer = () => {
  return (
    <footer className="bg-white rounded-b-[40px] shadow-sm">
      <div className="mx-auto px-[150px] py-16">
        <div className="flex flex-col lg:flex-row justify-between gap-16">
          ...
          <div className="flex gap-28">
            ...
            <div>
              ...
              <ul className="space-y-4 text-[#424242] text-[16px]">
          ...
          <div className="w-full max-w-xs">
            <h3 className="text-black font-semibold text-[16px] mb-8">Newsletter</h3>
            <input
              type="email"
            ...
            />
            <button className="w-full bg-[#7B3EFF] hover:bg-[#6a30f5] text-white py-4 rounded-xl font-semibold transition">
              Subscribe Now
            </button>
          </div>
        </div>
