...
const Section3 = () => {
  return (
    <div className='bg-[#FAFAFA] pb-20'>
      <div className='py-20 px-32'>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[80px] font-bold text-blue-700 mb-4 leading-tight">            
          <span className="relative inline-block">
      ...
      <div  >
        {/* className="bg-[url(src/assets/section3img5.png)] bg-contain bg-center" */}
        {/* <img src="src/assets/section3img5.png" alt="" className="absolute z-20"/> */}
        <div className='flex justify-between px-32'>
          <div className=' max-w-[410px] bg-[#FFFFFF] rounded-3xl p-6'>
            <div className='flex items-center pb-3'>
              <img src="src/assets/section3img1.png" alt="" className=' pr-5'/>
          ...
          <div className="flex items-end w-full gap-32">
            <div className="w-[50%] h-[50%] bg-[url(src/assets/section3img6.png)] bg-cover"></div>
            <div className="w-[50%] h-[50%] bg-[url(src/assets/section3img7.png)] bg-cover"></div>
          </div>
          <div className=' max-w-[410px] bg-[#FFFFFF] rounded-3xl p-6'>
            <div className='flex items-center pb-3'>
              <img src="src/assets/section3img2.png" alt="" className=' pr-5'/>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="z-10 w-32 h-32 rounded-full bg-purple-600 flex items-center justify-center">
            <img src="src/assets/section1img3.png" alt="Icon" className="w-32 h-32" />
          </div>
        </div>
        ...
        <div className='flex justify-between px-32'>
          <div className='max-w-[410px] bg-[#FFFFFF] rounded-3xl p-6'>
            <div className='flex items-center pb-3'>
              <img src="src/assets/section3img3.png" alt="" className=' pr-5'/>
  ...
  <div className="w-[50%] h-[50%] bg-[url('src/assets/section3img8.png')] bg-cover bg-bottom bg-no-repeat"></div>
  <div className="w-[50%] h-[50%] bg-[url('src/assets/section3img9.png')] bg-cover bg-bottom bg-no-repeat"></div>
</div>
