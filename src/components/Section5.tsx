  ...
  return (
    <div className="px-6 md:px-20 lg:px-40 pb-10">
      <div className="relative overflow-hidden rounded-[30px] md:rounded-[40px] bg-gradient-to-t from-[#AD88FF] to-[#8955FF]">
        <div className="flex flex-col items-center text-white sm:py-10 px-4 md:px-10 text-center">
          <div className="text-2xl sm:text-3xl md:text-4xl font-semibold sm:pt-3 mb-4 mt-10 leading-snug">
        ...
        <div className="bg-white h-[20px] md:h-[80px] w-full absolute bottom-0 left-0" />
      </div>
    </div>
  );
};
